...
public class EmployeeValidation implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors,"salary","phoneNumber.empty","Salary must not be empty");
        ...
        if (!employee.getSalary().matches("^[0-9]+")) {
            errors.rejectValue("salary","salary.error","Salary must be number >= 0");
        }
